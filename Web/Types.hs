...
instance Record LandingPageWithRecords where
  newRecord = LandingPageWithRecords newRecord def def def

instance SetField "paragraphCtas" LandingPageWithRecords [ParagraphCta] where
  setField :: [ParagraphCta] -> LandingPageWithRecords -> LandingPageWithRecords
  setField paragraphCtas r = r {paragraphCtas}
